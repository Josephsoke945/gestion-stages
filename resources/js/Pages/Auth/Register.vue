    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <TextInput id="prenom" type="text" class="mt-1 block w-full" v-model="form.prenom" required
            ...
            <div class="mt-4">
                ...
                <TextInput id="date_de_naissance" type="date" class="mt-1 block w-full" v-model="form.date_de_naissance"
                    required />
